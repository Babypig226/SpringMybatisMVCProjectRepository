...
public class GoodsController {
	...
	public String goodsForm(@ModelAttribute(value = "goodsCommand")GoodsCommand goodsCommand) {
		return "goodsView/goodsForm";
	}
	@RequestMapping("goodsPro")
	public String goodsPro(GoodsCommand goodsCommand, Errors errors, HttpServletRequest request) {
