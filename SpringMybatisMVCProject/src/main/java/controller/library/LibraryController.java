...
public class LibraryController {
	...
	public String libBoard(@RequestParam(value="page", required = false) Integer page, Model model){
		libraryBoardListService.libraryBoardList(model,page);
		return "lib_Board/lib_board_list";
	}
	@RequestMapping("boardWriteForm")
	public String boardWriteForm(@ModelAttribute(value = "libraryCommand")LibraryCommand libraryCommand/*,Model model*/) {
	...
	public String libBoardModifyPro(LibraryCommand libraryCommand, HttpSession session) {
		String path = libBoardModifyPro.libraryUpdate(libraryCommand, session);
		return path;
	}
