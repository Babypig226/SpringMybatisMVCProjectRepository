...
<body>
<form:form action="goodsPro" method="post" enctype="multipart/form-data" commandName = "goodsCommand">
	<table border="1">
		<tr><td>상품번호</td>
		...
		<tr><td>상품 설명</td>
			<td><form:textarea rows="13" cols="56" path="goodsContent" id="goodsContent"/>
